...
const FindingDetailsInformationRequest: React.FC<IProps> = () => {
		...
		>
			...
			{!showHistory && <>
				<Paper className={classes.paperForForm}>
					...
					{finding?.type !== FindingType.verbetering && finding?.featureRequestDescription && <Box
							display="flex"
							flexDirection="column"
							alignItems="flex-start"
							justifyContent="center"
...
export default FindingDetailsInformationRequest
